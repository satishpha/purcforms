...
public class OdmUtil {
	...
	/**
	 * Gets a list of xforms from a CDISC ODM document.
	 * 
	 * @param doc the ODM document.
	 * @return list of xforms.
	 */
	public static List<String> importXforms(Document doc){
		...
		for(int index = 0; index < nodes.getLength(); index++)
			xforms.add(importXform((Element)nodes.item(index),metaDataVersionNode));
