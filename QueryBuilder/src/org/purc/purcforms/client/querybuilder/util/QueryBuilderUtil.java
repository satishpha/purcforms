package org.purc.purcforms.client.querybuilder.util;
	...
	public static void loadQuestions(Vector questions, QuestionDef refQuestion, MultiWordSuggestOracle oracle, boolean dynamicOptions, boolean sameTypesOnly){
		...
		for(int i=0; i<questions.size(); i++){
			...
			if(questionDef.isGroupQtnsDef())
				loadQuestions(questionDef.getGroupQtnsDef().getQuestions(),refQuestion,oracle,dynamicOptions,sameTypesOnly); //TODO These have different id sets and hence we are leaving them out for now
		}
	}
