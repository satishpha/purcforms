...
import org.purc.purcforms.client.querybuilder.widget.ColumnActionHyperlink;
import org.purc.purcforms.client.querybuilder.widget.DisplayColumnWidget;
import org.purc.purcforms.client.querybuilder.widget.SortColumnActionHyperlink;
import org.purc.purcforms.client.querybuilder.widget.SortColumnWidget;
	...
	public List<DisplayField> getDisplayFields(){
		...
		for(int i=1; i<count; i++){
			...
			if(widget instanceof DisplayColumnWidget){
				...
				displayFields.add(new DisplayField(displayColumnWidget.getName(),displayColumnWidget.getText(),displayColumnWidget.getAggregateFunction(),displayColumnWidget.getDataType(), displayColumnWidget.getQuestionDef()));
			}
		}
